...
function Category({ onCategoryClick }) {
    const renderItems = () => (
        Categories.map(item => {
            return (
                <li key={item.id} className='w-[100%] h-[145px] border-[1px] border-[rgba(0,0,0,0.3)] border-solid rounded-[4px] flex items-center justify-center max-[1100px]:w-[170px] max-[1100px]:mt-[30px] hover:bg-[#DB4444]' onClick={()=>onCategoryClick(item.category)}>
    ...
    return (
        <div>
            <div className='mx-auto w-[90%] mt-[54px]'>
                ...
                <div className='font-interSemi text-[36px] mt-[28px] max-[680px]:text-[28px]'>Browse By Category</div>
