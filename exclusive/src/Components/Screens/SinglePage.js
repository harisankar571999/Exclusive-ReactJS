            ...
            <li className='w-[50%] h-[600px]'>
                <div className='bg-[#f5f5f5] w-[100%] h-[600px] flex items-center justify-center'>
                    <div className='w-[450px] h-[315px]'>
                        <img src={require("../Assets/jacket .png")} alt="jacket .png" className='w-[450px] h-[315px]'/>
                    </div>
                </div>
            </li>
            <li className='self-center w-[50%]'>
                <div className='flex flex-col gap-[16px]' >
                    <h1 className='font-interSemi text-[24px]'>Havic HV G-92 Gamepad</h1>
                    <div className='flex flex-col gap-[16px]'>
                        <div  className='flex items-center gap-[8px]'>
                            <div className='self-center'>
                                <img src={require("../Assets/Four Star.png")} alt="Four Star.png" />
                            </div>
                            <div className='flex items-center gap-[16px]'>
                                <span className='font-poppinReg text-[14px] text-[#000] opacity-[50%]'>(150 reviews)</span>
                        ...
                        <div className='font-interBold text-[18px]'>$192.00</div>
                        <div>
                        ...
                        <div className='flex gap-[24px] items-center'>
                            ...
                            <div>
                                <img src={require('../Assets/yellow and red.png')} alt="" />
                            </div>
                        </div>
                        <div>
